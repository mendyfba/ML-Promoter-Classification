...
Ce dépôt contient un script Python (notebook) permettant de classer des séquences d'ADN procaryotes. L'objectif est de déterminer si une séquence est un promoteur ou non en utilisant des méthodes de traitement du langage naturel (NLP) appliquées à la génomique.
